...
def process_ros2_controllers_config(context):
    ...
    src_config_path = os.path.join(
        home,
        'mobile_robot_ws/src/mobile_robot/mobile_robot_description/config',
        robot_name
    )
    install_config_path = os.path.join(
        home,
        'mobile_robot_ws/install/mobile_robot_description/share/mobile_robot_description/config',
        robot_name
    )
...
def generate_launch_description():
    # Define filenames
    urdf_package = 'mobile_robot_description'
    urdf_filename = 'mobile_robot.urdf.xacro'
    rviz_config_filename = 'mobile_robot_description.rviz'
    ...
    start_rviz_cmd = Node(
        ...
        executable='rviz2',
        output='screen',
        arguments=['-d', '/home/jpst/mobile_robot_ws/src/mobile_robot/mobile_robot_description/rviz/mobile_robot_description.rviz'],
        parameters=[{'use_sim_time': use_sim_time}])
